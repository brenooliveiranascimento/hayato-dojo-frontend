...
export default function Login() {
  ...
  return (
    <>
      <div className="min-h-screen bg-gradient-to-br from-red-50 to-orange-100 flex items-center justify-center p-4 flex-col">
        ...
        <p className="text-sm text-gray-600 flex items-center justify-center md:justify-start space-x-1 mt-10">
